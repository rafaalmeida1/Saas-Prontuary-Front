    ...
    return (
        <div className="max-w-full mx-auto px-2 py-6">
            ...
            <div className="grid grid-cols-1 gap-4">
                ...
                {renderCard("Avaliação Nutricional", ["nivel_assistencia_nutricao", "classificacao_apetite", "ingestao_alimentar", "tipo_dieta_atual"])}
                {renderCard("Condição física", ["condicao_fisica", "presenca_edema", "localizacao_edema", "avaliacao_subjetiva", "apresenta_lipodistrofia", "localizacao_lipodistrofia"])}
                {renderCard("Hábitos", ["frequencia_defecacao", "caracteristicas_fezes", "frequencia_miccao", "caracteristicas_urina", "qualidade_sono", "hora_dormir", "hora_acordar"])}
                {renderCard("Estado de saúde", ["sinais_e_sintomas", "historico_atual_patologias", "medicacoes_atuais", "dificuldade_engolir"])}
                {renderCard("Informações sobre dieta", ["alimentos_preferidos", "alimentos_menos_preferidos", "alergias", "alergia_detalhes"])}
                {renderCard("Avaliação", ["queixas_reclamacoes", "periodo_avaliacao", "mes", "evolucao_dietoterapica", "alteracoes_patologicas_farmacologicas", "tipo_prescricao", "prescricao_detalhada"])}
            </div>
                            ...
                            <Table className="table-auto min-w-full text-sm">
                                <TableHeader>
                                    <TableRow>
                                        ...
                                        <TableHead className="hidden md:table-cell">Pesos (R/L)</TableHead>
                                        <TableHead className="hidden md:table-cell">Alturas (R/L)</TableHead>
